...
def hangman(secret_word):
    ...
    print ("")
    print(secret_word)
    user_difficulty_choice = input("Aap abhi kitani difficulty per ye game khelna chahoge?\na)\tEasy\nb)\tMedium\nc)\tHard\n\napni choice a , b , ya c ki trem mei batain\n")
    ...
    while (remaining_lives > 0):
        ...
        if letter == "hint":
            print("your hint for this word: " + get_hint(secret_word,letters_guessed))
            continue
        else:
            ...
            if letter in secret_word:
                ...
                print("remainig lives:",remaining_lives)
                print ("")
                letters_guessed.append(letter)
                remaining_lives -=1
    else:
